...
describe('app', () => {
  it('should emit "mount" when mounted', (t, done) => {
    const blog = express()
      , app = express()
  ...
  describe('.use(app)', () => {
    it('should mount the app', (t, done) => {
      const blog = express()
        , app = express()
    ...
    it('should support mount-points', (t, done) => {
      const blog = express()
        , forum = express()
        , app = express()
    ...
    it('should support mounted app anywhere', (t, done) => {
  ...
  describe('.use(middleware)', () => {
    it('should accept multiple arguments', (t, done) => {
      const app = express()
    ...
    it('should invoke middleware for all requests', (t, done) => {
      const app = express()
      const cb = after(3, done)
    ...
    it('should accept multiple arrays of middleware', (t, done) => {
      const app = express()
    ...
    it('should accept nested arrays of middleware', (t, done) => {
      const app = express()
  ...
  describe('.use(path, middleware)', () => {
    ...
    it('should invoke middleware for all requests starting with path', (t, done) => {
      const app = express()
      const cb = after(3, done)
    ...
    it('should work if path does not have trailing slash', (t, done) => {
      const app = express()
      const cb = after(3, done)
    ...
    it('should support array of paths', (t, done) => {
      const app = express()
      const cb = after(3, done)
    ...
    it('should support array of paths with middleware array', (t, done) => {
      const app = express()
      const cb = after(2, done)
    ...
    it('should support empty string path', (t, done) => {
      const app = express()
