  ...
  describe('.ip', () => {
    describe('when X-Forwarded-For is present', () => {
      describe('when "trust proxy" is enabled', () => {
        it('should return the client addr', (t, done) => {
          const app = express()
        ...
        it('should return the addr after trusted proxy based on count', (t, done) => {
          const app = express()
        ...
        it('should return the addr after trusted proxy based on list', (t, done) => {
          const app = express()
        ...
        it('should return the addr after trusted proxy, from sub app', (t, done) => {
          const app = express()
          const sub = express()
      ...
      describe('when "trust proxy" is disabled', () => {
        it('should return the remote address', (t, done) => {
          const app = express()
