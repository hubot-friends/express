...
describe('req', () => {
  describe('.subdomains', () => {
    describe('when present', () => {
      it('should return an array', (t, done) => {
        const app = express()
      ...
      it('should work with IPv4 address', (t, done) => {
        const app = express()
      ...
      it('should work with IPv6 address', (t, done) => {
        const app = express()
    ...
    describe('when subdomain offset is set', () => {
      describe('when subdomain offset is zero', () => {
        it('should return an array with the whole domain', (t, done) => {
          const app = express()
        ...
        it('should return an array with the whole IPv4', (t, done) => {
          const app = express()
          app.set('subdomain offset', 0)
        ...
        it('should return an array with the whole IPv6', (t, done) => {
          const app = express()
          app.set('subdomain offset', 0)
